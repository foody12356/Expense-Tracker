  ...
  return (
    <>
      <div className="row m-3">
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-header">Total TurOver: {totalTurnover}</div>
            <div className="card-body">
